...
BLOG_AUTHOR = "Ilia Ozhmegov"  # (translatable)
BLOG_TITLE = "IO"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://ozhmegov.com/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://ozhmegov.com/"
BLOG_EMAIL = "ilia.ozhmegov@gmail.com"
BLOG_DESCRIPTION = "Personal website of Ilia Ozhmegov"  # (translatable)
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ...
        ("/categories/cat_writings/", "Writings"),
        ("/categories/cat_readings/", "Readings"),
        ("/pages/about", "About"),
    ),
}
...
POSTS = (
    ("posts/readings/*.rst",  "readings", "post.tmpl"),
    ("posts/readings/*.md",   "readings", "post.tmpl"),
    ("posts/readings/*.txt",  "readings", "post.tmpl"),
    ("posts/readings/*.html", "readings", "post.tmpl"),

    ("posts/writings/*.rst",   "writings", "post.tmpl"),
    ("posts/writings/*.md",    "writings", "post.tmpl"),
    ("posts/writings/*.txt",   "writings", "post.tmpl"),
    ("posts/writings/*.html",  "writings", "post.tmpl"),
    ("posts/writings/*.ipynb", "writings", "post.tmpl"),
)
PAGES = (
...
CATEGORY_DESCRIPTIONS = {
   DEFAULT_LANG: {
       "readings":
       """
       In this section, I share links to articles, blog
       posts, and books that I've come across.
       As someone who consumes a lot of
       technical information, I've found it challenging to keep track of
       everything I've read and to find specific articles when I need to refer
       back to them for research or development.

       <br><br>
       This section serves
       two purposes for me: first, it helps me to organize my thoughts and
       better understand the material by summarizing it and condensing it into
       a few sentences. Second, it provides a way for me to discipline myself
       by making a daily commitment to reading and summarizing technical
       content. I hope that my summaries and reviews can also be helpful to
       others who are interested in these topics.
       """,
       "writings":
       """
       In this section, I share my own original content on various technical
       topics. While I do aim to provide informative and engaging articles, I
       also write for myself and to practice explaining complicated topics.
       Sometimes I write on topics that have already been well-described in
       other resources, but I believe that by explaining these topics in my
       own words, I can better understand them and improve my methodology of
       learning and exploring complex subjects.
       """
...
# (translatable)
# EXTRA_HEAD_DATA = '''
# <script src="https://cdnjs.cloudflare.com/ajax/libs/require.js/2.3.6/require.min.js"></script><script>requirejs.config({paths: { 'plotly': ['https://cdn.plot.ly/plotly-latest.min']},});if(!window.Plotly) {{require(['plotly'],function(plotly) {window.Plotly=plotly;});}}</script>
# '''
